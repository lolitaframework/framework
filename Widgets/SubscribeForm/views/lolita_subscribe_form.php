...
<?php if ('' !== $instance['error_message']): ?>
    <span class="lolita-subscribe-error-message" style="display:none;"><?php echo $instance['error_message'] ?></span>
<?php else: ?>
...
<div class="lolita-subscribe">
    ...
    <form id="<?php echo $id_base; ?>" class="lolita-subscribe-form" action="" method="post" accept-charset="utf-8">
        ...
        <input type="submit" name="lolita_subscribe_submit" value="Submit">
